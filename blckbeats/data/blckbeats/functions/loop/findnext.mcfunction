scoreboard players add @s current.blbt 1
execute if entity @s[scores={current.blbt=21..}] run scoreboard players set @s current.blbt 1
...
execute unless entity @s[tag=play.blbt] run function blckbeats:loop/findnext
